...
async def test_get_conversation_by_id_success():
    ...
    with patch('app.mongodb.collection', new_callable=AsyncMock) as mock_collection:
        ...
        mock_collection.find_one.assert_called_once_with({"_id": ObjectId(mock_conversation_id)})
