...
adviser_prompts = """
Analyze the following individual's priorities and values based on their actions and context. Below is a list of attributes. Based on the information provided, determine which attributes align with the individual's authentic values. The text should be structured with a paragraph summurising the result of the analysis, followed by an ordered list explaining how each attribute applies to them. The form of the list is [number]. **attribute** - explanation. Do not add conlusion sentences.
